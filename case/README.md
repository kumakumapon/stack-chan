...
- Case v0 (this document)
  - PCB: [`v0.2.1`](https://github.com/kumakumapon/stack-chan/tree/v0.2.1/schematics)
...
__Caution: Do not use "Recovery" from the GUI. There are issues that the servo does not work properly after recovery (confirmed in FD v1.9.8.1 and v1.9.8.2)__.
