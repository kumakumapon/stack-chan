...
「ｽﾀｯｸﾁｬﾝ」は本リポジトリの管理下にあるデータのみを使って作られたロボットを指します。
...
2. 参照先として、ｽﾀｯｸﾁｬﾝのGitHubリポジトリのURL（https://github.com/kumakumapon/stack-chan）

以下のような例文がどこかに貼ってあればOKです。

ｽﾀｯｸﾁｬﾝは[ししかわ](https://twitter.com/stack_chan)が開発、公開している、
手乗りサイズのｽｰﾊﾟｰｶﾜｲｲコミュニケーションロボットです。
作品ページ：https://github.com/kumakumapon/stack-chan
