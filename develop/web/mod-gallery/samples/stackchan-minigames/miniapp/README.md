...
The existing [`mini_app_sample`](https://github.com/kumakumapon/stack-chan/tree/develop/firmware/mods/examples/mini_app_sample) and [`stackchan_catch`](https://github.com/kumakumapon/stack-chan/tree/develop/firmware/mods/examples/stackchan_catch) implementations remain the source of truth. `compose.mjs` combines them into one import-allowlist-compatible `miniapp.ts`. See each source sample's README for gameplay and rendering details.
